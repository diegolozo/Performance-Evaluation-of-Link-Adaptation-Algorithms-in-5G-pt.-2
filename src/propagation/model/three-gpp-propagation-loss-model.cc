    ...
    static TypeId tid =
        TypeId("ns3::ThreeGppPropagationLossModel")
            ...
            .AddAttribute(
                        ...
                        MakeBooleanChecker())
            .AddAttribute("CustomLoss",
                    "Additional Custom loss [dB]",
                    DoubleValue(0),
                    MakeDoubleAccessor(&ThreeGppPropagationLossModel::m_CustomLoss),
                    MakeDoubleChecker<double>())
            .AddAttribute("CustomLossLos",
                    "Additional Custom loss LoS [dB]",
                    DoubleValue(0),
                    MakeDoubleAccessor(&ThreeGppPropagationLossModel::m_CustomLossLos),
                    MakeDoubleChecker<double>())
            .AddAttribute("CustomLossNlos",
                    "Additional Custom loss NLoS [dB]",
                    DoubleValue(0),
                    MakeDoubleAccessor(&ThreeGppPropagationLossModel::m_CustomLossNlos),
                    MakeDoubleChecker<double>());
    return tid;
}
                                      ...
                                      double hBs) const
{
    ...
    {
        loss = GetLossLos(distance2d, distance3d, hUt, hBs) + m_CustomLossLos;
    }
    ...
    {
        loss = GetLossNlos(distance2d, distance3d, hUt, hBs) + m_CustomLossNlos;
    }
    else
    {
