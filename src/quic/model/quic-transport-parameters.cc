...
{
  os << "[initial_max_stream_data " << m_initial_max_stream_data << "|"; // JSA Final "\n" removed
  os << "|initial_max_data " << m_initial_max_data << "|"; // JSA Final "\n" removed
  os << "|initial_max_stream_id_bidi " << m_initial_max_stream_id_bidi << "|"; // JSA Final "\n" removed
  os << "|idleTimeout " << m_idleTimeout << "|"; // JSA Final "\n" removed
  os << "|omit_connection " << (uint16_t)m_omit_connection << "|"; // JSA Final "\n" removed
  os << "|max_packet_size " << m_max_packet_size << "|"; // JSA Final "\n" removed
  //os << "|stateless_reset_token " << m_stateless_reset_token << "|"; // JSA Final "\n" removed
  os << "|ack_delay_exponent " << (uint16_t)m_ack_delay_exponent << "|"; // JSA Final "\n" removed
  os << "|initial_max_stream_id_uni " << m_initial_max_stream_id_uni << "]"; // JSA Final "\n" removed
}
